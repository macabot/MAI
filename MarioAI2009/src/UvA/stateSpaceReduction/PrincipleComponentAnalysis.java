...
public class PrincipleComponentAnalysis implements Serializable 
{
    ...
    /**
     * Adds all sample data to internal data structure for later processing.
     * All the samples must be added before computeBasis is called.
     * @param sampleData
     */
    public void addSamples( double[][] sampleData )
    {
    	for(int i=0; i<sampleData.length; i++)
